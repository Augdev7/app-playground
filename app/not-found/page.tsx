        ...
        <div className="prose prose-sm prose-invert max-w-none">
            ...
            <ul>
                ...
                <li>
                    ...
                    <Link href="/not-found/electronics/does-not-exist">Sub Categories</Link> that do
                    not exist. This renders the closest appropriate <code>not-found.js</code>.
                </li>
                <li>
                    <em>
                        Note: <code>not-found.js</code> currently only renders when triggered by the{' '}
                        <code>notFound()</code> function. We&apos;re working on support for catching
