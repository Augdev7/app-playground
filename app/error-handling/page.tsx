    ...
    return (
        <div className="prose prose-sm prose-invert max-w-none">
            ...
            <ul>
                ...
                <li>
                    Trying navigation pages and triggering an error inside nested layouts. Notice
                    how the error is isolated to that segment, while the rest of the app remains
                    interactive.
                </li>
            </ul>
