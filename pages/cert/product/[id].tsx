...
import { getProduct, getProducts, GetProduct } from '#/lib/page-directory/get-products';
...
export const getStaticProps: GetStaticProps<{ product: GetProduct }> = async context => {
